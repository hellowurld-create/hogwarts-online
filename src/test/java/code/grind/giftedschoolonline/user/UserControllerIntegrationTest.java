...
public class UserControllerIntegrationTest {
    ...
    void testAddUserErrorWithInvalidInput() throws Exception {
        User User = new User();
        User.setUsername(""); // Username is not provided.
        User.setPassword(""); // Password is not provided.
        User.setRoles(""); // Roles field is not provided.
    ...
    void testUpdateUserSuccess() throws Exception {
        User User = new User();
        User.setUsername("tom123"); // Username is changed. It was tom.
    ...
    void testUpdateUserErrorWithNonExistentId() throws Exception {
        User User = new User();
        User.setId(5); // This id does not exist in the database.
        User.setUsername("john123"); // Username is changed.
        User.setEnabled(true);
    ...
    void testUpdateUserErrorWithInvalidInput() throws Exception {
        User User = new User();
        User.setId(1); // Valid id
        User.setUsername(""); // Updated username is empty.
        User.setRoles(""); // Updated roles field is empty.
